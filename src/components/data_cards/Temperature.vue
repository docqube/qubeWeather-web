...
export default {
    ...
    methods:{
        fillData(){
            ...
            this.$http.get('?sensor=temperature&starttime='+encodeURI(startTime.toUTCString())+'&endtime='+encodeURI(endTime.toUTCString())).then(response => {
                var times = new Array();
